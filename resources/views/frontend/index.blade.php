        ...
        <div class="container">
            <nav id="navigation" class="navigation navigation-landscape">
                <div class="nav-header">
                    <a class="nav-brand static-logo" href="#"><img src="assets/img/logo_new_light.png" class="logo" alt="" /></a>
                    <a class="nav-brand fixed-logo" href="#"><img src="assets/img/logo_new_dark.png" class="logo" alt="" /></a>
...
{{--                        <li><a href="JavaScript:Void(0);" data-bs-toggle="modal" data-bs-target="#signup">Sign Up</a></li>--}}
                    ...
                    <ul class="nav-menu nav-menu-social align-to-right">
                        <li class="add-listing light">
                            <a href="#"><img src="assets/img/user.svg" width="12" alt="" class="mr-2" />Contact Us</a>
                        </li>

{{--                        <li>--}}
{{--                            <a href="submit-property.html" class="text-light"><img src="assets/img/submit.svg" width="20" alt="" class="mr-2" />Add Property</a>--}}
{{--                        </li>--}}
{{--                        <li class="add-listing light">--}}
...
{{--                        </li>--}}
    ...
    <!-- ============================ Hero Banner  Start================================== -->
    <div class="image-cover hero-banner" style="background:url(assets/img/banner.jpg) no-repeat;" data-overlay="6">
        <div class="container">

            <h1 class="big-header-capt mb-0">Find Your Property</h1>
            <p class="text-center mb-5">Find properties in Nigeria for sale, for rent, joint-ventures etc</p>
                        ...
                        <div class="listing-img-wrapper">
                            <div class="list-img-slide">
                                <div class="click">
                                    ...
                                    <div><a href="single-property-1.html"><img src="assets/img/p-12.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                                    <div><a href="single-property-1.html"><img src="assets/img/p-25.jpg" class="img-fluid mx-auto" alt="" /></a></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="footer-widget">
                            <img src="assets/img/logo_new_light.png" class="img-footer" alt="" />
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <p class="mb-0">© 2022 JKF Properties, All Rights Reserved</p>
                    </div>
